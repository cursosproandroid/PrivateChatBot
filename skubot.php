...
if (file_exists(__DIR__ . '/language/default.json')) {
    ...
    $LANG = json_decode('{
    "START": "Hola [👋](https://te.legra.ph/file/9d8ed29730e244f147301.jpg), puedes enviar un mensaje a mi propietario con este bot. ¡Mi propietario responderá tu mensaje lo antes posible!\nHecho con ❤️ por [Skueletor](https://telegram.me/DKzippO)",
    "ERROR_REPLY": "*Debes responder un mensaje.*",
